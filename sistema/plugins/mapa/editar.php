...
switch($case){
	...
	default:
		$consulta = "select * from ".SUFIXO."mapa where id like $id";
...
<div class="boxCenter">
	<form method="post" class="form" id="formula">
		...
		<div class="label">
			...
			<span class="ex">Aqui é o embed de seu mapa. Pode ser do google ou qualquer outro mapa. Link do google http://www.google.com.br/maps</span>
		</div>
		...
		<?php
			$prefixo = "mp";
			$retorno = "plugin=mapa*acoes=editar*id=".$id;
