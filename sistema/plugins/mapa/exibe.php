...
if(!isset($_GET['id'])){
	...
	if(mysql_num_rows($query) > 0){ ?>
		...
		while($dados = mysql_fetch_array($query)){
			...
			?>
			<span class="foto">
				<a href="sistema/plugins/galeria/uploads/<?=$foto?>" rel="lightbox[0]" title="<?=$descricao?>">
					<img src="sistema/includes/thumbs.php?imagem=150-../plugins/galeria/uploads/<?=$foto?>-100" alt="" />
				</a>
			</span>
			<?php
		}	 ?>
