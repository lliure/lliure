...
if(mysql_num_rows($query) > 0){ ?>
	...
	while($dados = mysql_fetch_array($query)){
		...
		?>
		<span class="foto">
			<a href="sistema/includes/marcadagua.php?img=../../uploads/produtos/<?=$foto?>" rel="lightbox[0]" title="<?=$descricao?>">
...
if (isset($_POST['nome'])) {
	...
	$query = mysql_query($consulta);
		...
		$conteudo .= "
			...
			<tr>
				<td>
					<a href='http://www.denispolitani.com.br/?catalogo&prod=".$_GET['prod']."'>".$nomeProd."</a>
				</td>
			</tr>
			<tr>
				<td>
		...
		mail('denispolitani@yahoo.com.br','Proposta para imóvel',$conteudo,$headers);
