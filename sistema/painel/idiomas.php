		...
		$pg_idiomas .= '<table class="table">'
			...
			foreach($arrayConf['idiomas'] as $chave => $valor){
				$pg_idiomas .= '<tr>'
									...
									.'<td><a href="painel/idiomas.php?ac=natv&amp;idi='.$valor.'" class="jfbox"><img src="imagens/icones/'.($chave == 'nativo' ? 'round_checkmark' : 'round').'.png"></a></td>'
									
									.'<td><a href="painel/idiomas.php?ac=del&amp;idi='.$valor.'" class="jfbox"><img src="imagens/icones/trash.png"></a></td>'
							  .'</tr>';
