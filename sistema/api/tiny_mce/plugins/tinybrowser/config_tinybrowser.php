...
$caminho = join('/',array_reverse($caminho));
...
$tinybrowser['path']['image'] = $caminho.'/uploads/images/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = $caminho.'/uploads/media/'; // Media files location
$tinybrowser['path']['file']  = $caminho.'/uploads/files/'; // Other files location
