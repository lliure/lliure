<?php
/**
* Gerenciamento de API | lliure 4.10
*
* @Desenvolvedor Carlos Alberto Bertholdo Carucce <carloscarucce@gmail.com>
* @Contribuição Jeison Frasson <jomadee@lliure.com.br>
*/
class lliure {
